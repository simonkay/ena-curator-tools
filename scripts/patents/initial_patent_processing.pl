...
#  $RCSfile: initial_patent_processing.pl,v $
#  $Revision: 1.8 $
#  $Date: 2011/06/20 09:39:35 $
#  $Source: /ebi/cvs/seqdb/seqdb/tools/curators/scripts/patents/initial_patent_processing.pl,v $
#  $Author: xin $
#
#===============================================================================
...
sub main (\@) {
    ...
    check_inventor_names($patentFile, $LOGFILE, $logFileName, $PATENT_WORKING_DIR, $verbose);
    ...
    check_orgs_are_ok($patentFile, $processOldFormat, $verbose, $LOGFILE);
